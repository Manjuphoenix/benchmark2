...
MUSES_FOG_DAY_SPLITS = {
    "muses_conv-fog-day_{task}_train": ("muses/frame_camera/train/fog/day/",
                                    "muses/gt_semantic/train/fog/day/"),
    "muses_conv-fog-day_{task}_val": ("muses/frame_camera/val/fog/day/",
                                    "muses/gt_semantic/val/fog/day/"),
}

def register_muses_conv_fog_day(root):
...
register_muses_conv_fog_day(_root)