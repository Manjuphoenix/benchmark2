...
_RAW_CITYSCAPES_COLORED_RESIZED_SPLITS = {
    "cs_conv-normal_{task}_train": ("cityscapes/leftImg8bit/train/", "cityscapes/gtFine/train/"),
    "cs_conv-normal_{task}_val": ("cityscapes/leftImg8bit/val/", "cityscapes/gtFine/val/"),
}

def register_colored_resized_cityscapes_conv(root):
...
register_colored_resized_cityscapes_conv(_root)