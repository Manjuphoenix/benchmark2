...
MUSES_RAIN_DAY_SPLITS = {
    "muses_conv-rain-day_{task}_train": ("muses/frame_camera/train/rain/day/",
                                    "muses/gt_semantic/train/rain/day/"),
    "muses_conv-rain-day_{task}_val": ("muses/frame_camera/val/rain/day/",
                                    "muses/gt_semantic/val/rain/day/"),
}

def register_muses_conv_rain_day(root):
...
register_muses_conv_rain_day(_root)