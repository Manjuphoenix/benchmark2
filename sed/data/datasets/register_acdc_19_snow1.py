...
ACDC_SNOW_SPLITS = {
    "acdc_conv-snow_{task}_train": ("acdc/rgb_anon/snow/train/",
                                    "acdc/gt/snow/train/"),
    "acdc_conv-snow_{task}_val": ("acdc/rgb_anon/snow/val/",
                                    "acdc/gt/snow/val/"),
    "acdc_conv-snow_{task}_test": ("acdc/rgb_anon/snow/test/",
                                    "acdc/gt/snow/test/"),
}
