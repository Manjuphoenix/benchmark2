...
ACDC_NIGHT_SPLITS = {
    "acdc_conv-night_{task}_train": ("acdc/rgb_anon/night/train/",
                                    "acdc/gt/night/train/"),
    "acdc_conv-night_{task}_val": ("acdc/rgb_anon/night/val/",
                                    "acdc/gt/night/val/"),
    "acdc_conv-night_{task}_test": ("acdc/rgb_anon/night/test/",
                                    "acdc/gt/night/test/"),
}
