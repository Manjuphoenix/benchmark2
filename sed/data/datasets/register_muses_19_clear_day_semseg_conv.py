...
MUSES_CLEAR_DAY_SPLITS = [
    ("train", "muses/frame_camera/train/clear/day/", "muses/gt_semantic/train/clear/day/"),
    ("val", "muses/frame_camera/val/clear/day/", "muses/gt_semantic/val/clear/day/"),
]

def register_muses_conv_clear_day(root):
    ds_name = 'muses_conv-clear-day'
...
register_muses_conv_clear_day(_root)