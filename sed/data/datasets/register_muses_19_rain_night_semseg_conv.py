...
MUSES_RAIN_NIGHT_SPLITS = {
    "muses_conv-rain-night_{task}_train": ("muses/frame_camera/train/rain/night/",
                                    "muses/gt_semantic/train/rain/night/"),
    "muses_conv-rain-night_{task}_val": ("muses/frame_camera/val/rain/night/",
                                    "muses/gt_semantic/val/rain/night/"),
}

def register_muses_conv_rain_night(root):
...
register_muses_conv_rain_night(_root)