...
IDD_COLORED_SPLITS = {
    "idd_{task}_train": ("idd/IDD_Segmentation/leftImg8bit/train", "idd/IDD_Segmentation/gtFine/train"),
    "idd_{task}_val": ("idd/IDD_Segmentation/leftImg8bit/val", "idd/IDD_Segmentation/gtFine/val"),
}
...
# }
    ...
    for split, image_dirname, sem_seg_dirname, class_names in [
        ...
        ('train', 'idd/IDD_Segmentation/leftImg8bit/train', 'idd/IDD_Segmentation/gtFine/train', CLASSES),
        ('val', 'idd/IDD_Segmentation/leftImg8bit/val', 'idd/IDD_Segmentation/gtFine/val', CLASSES),
    ]:
    ...
    # for key, (image_dir, gt_dir) in IDD_COLORED_SPLITS.items():
        ...
        DatasetCatalog.register(
            full_name,
            lambda x=image_dir, y=gt_dir: load_idd_semantic(
                x, y,
                # gt_ext='tif', image_ext='tif'
            ),
        )
