...
MUSES_SNOW_DAY_SPLITS = {
    "muses_conv-snow-day_{task}_train": ("muses/frame_camera/train/snow/day/",
                                    "muses/gt_semantic/train/snow/day/"),
    "muses_conv-snow-day_{task}_val": ("muses/frame_camera/val/snow/day/",
                                    "muses/gt_semantic/val/snow/day/"),
}

def register_muses_conv_snow_day(root):
...
register_muses_conv_snow_day(_root)