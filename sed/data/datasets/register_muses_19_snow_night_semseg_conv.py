...
MUSES_SNOW_NIGHT_SPLITS = {
    "muses_conv-snow-night_{task}_train": ("muses/frame_camera/train/snow/night/",
                                    "muses/gt_semantic/train/snow/night/"),
    "muses_conv-snow-night_{task}_val": ("muses/frame_camera/val/snow/night/",
                                    "muses/gt_semantic/val/snow/night/"),
}

def register_muses_conv_snow_night(root):
...
register_muses_conv_snow_night(_root)