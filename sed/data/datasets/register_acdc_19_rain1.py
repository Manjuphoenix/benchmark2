...
ACDC_RAIN_SPLITS = {
    "acdc_conv-rain_{task}_train": ("acdc/rgb_anon/rain/train/",
                                    "acdc/gt/rain/train/"),
    "acdc_conv-rain_{task}_val": ("acdc/rgb_anon/rain/val/",
                                    "acdc/gt/rain/val/"),
    "acdc_conv-rain_{task}_test": ("acdc/rgb_anon/rain/test/",
                                    "acdc/gt/rain/test/"),
}
