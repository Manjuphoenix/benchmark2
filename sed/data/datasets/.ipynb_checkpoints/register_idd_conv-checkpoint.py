...
# }
    ...
    for split, image_dirname, sem_seg_dirname, class_names in [
        ...
        ('train', 'IDD_Segmentation/leftImg8bit/train', 'IDD_Segmentation/gtFine/train', CLASSES),
        ('val', 'IDD_Segmentation/leftImg8bit/val', 'IDD_Segmentation/gtFine/val', CLASSES),
    ]:
