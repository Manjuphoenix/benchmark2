...
MUSES_FOG_NIGHT_SPLITS = {
    "muses_conv-fog-night_{task}_train": ("muses/frame_camera/train/fog/night/",
                                    "muses/gt_semantic/train/fog/night/"),
    "muses_conv-fog-night_{task}_val": ("muses/frame_camera/val/fog/night/",
                                    "muses/gt_semantic/val/fog/night/"),
}

def register_muses_conv_fog_night(root):
...
register_muses_conv_fog_night(_root)